...
<head>
    ...
    <title>Sistem Informasi Peramalan Stock Opname Obat dan Alat Medis - RSIA SOERYA </title>
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">SIMFORECAST</span>
            </a>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " href="/transactiondata">
            ...
            <!-- Product Management Page Nav -->
            <li class="nav-item">
                <a class="nav-link " href="/forecastinghw">
                    <i class="bi bi-graph-up"></i>
                    <span>Forecast Holt Winters</span>
                </a>
            </li>
